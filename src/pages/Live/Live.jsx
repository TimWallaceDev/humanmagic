        ...
        <main className="live">
            ...
            <div className="live__content">
                ...
                <article className="live__item">
                    <iframe className="live__iframe" src="https://www.youtube.com/embed/QhMI0Rs5cHo?si=9aAwzW7npuW0JudF" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <h4 className="live__title">Colorful / Overjoy</h4>
                    <h5 className="live__venue">Official Music Video</h5>
                </article>

                <hr className="hr hr--mobile"></hr>

                <article className="live__item">
                    <iframe className="live__iframe" src="https://www.youtube.com/embed/u1MGNvg6nec?si=Hh0CzBncAHjK5SBv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <h4 className="live__title">My Brother</h4>
                    <h5 className="live__venue">Official Music Video</h5>
                </article>
                ...
                <article className="live__item">
                    <iframe className="live__iframe" src="https://www.youtube.com/embed/A4XzrYyryIc?si=YSSzgbztsvW_OCo8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <h4 className="live__title">Love Machine (Cover)</h4>
                ...
                <article className="live__item">
                    <iframe className="live__iframe" src="https://www.youtube.com/embed/37O98vFDkdQ?si=XNEs4fB5SRLDuntb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
