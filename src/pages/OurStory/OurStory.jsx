...
export function OurStory() {
    ...
    return (
        <main className="story">
            <h1 className="story__heading-top">The Story of Human Magic</h1>
            <hr className="hr hr--top" />

            <div className="story__content">
                <article className="quote">
                    <blockquote className="quote__text">
                        "Toronto's Power Disco Explosion"
                    </blockquote>
                    <span className="quote__author">
                        - Dan Burke, legendary Toronto promoter
                    </span>
                </article>

                <article className="quote">
                    <blockquote className="quote__text">
                        “Human Magic is the newest promising name on the Toronto music scene, with a versatility that has followed him since his adolescence, the Canadian artist has been delivering complete works and extremely elegant sound on his digital platforms.”
                    </blockquote>
                    <span className="quote__author">
                        - Gabriel Mestrinel, Roadie Music, Portugal
                    </span>
                </article>

                <article className="quote">
                    <blockquote className="quote__text">
                        "When I first saw Human Magic perform, it reminded me instantly of the great high-energy ensemble bands: tons of people on stage playing various instruments (both men and women, like Talking Heads, Arcade Fire, Broken Social Scene) and having an exhilarating time. There’s no cool-guying it here -- everyone is having authentic fun. It also made me think that more people need to know about their existence..."
                    </blockquote>
                    <span className="quote__author">
                        - Evan Rissi, Filmmaker, Toronto
                    </span>
                </article>

                <article className="story__story">
                    <h2 className="story__heading">The Story of Human Magic</h2>
